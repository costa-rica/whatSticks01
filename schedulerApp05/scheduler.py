...
import sys
sys.path.insert(1, r'C:\Users\captian2020\Documents\whatSticks01\whatSticksApi04')
from models import sess, Users, Locations, Weather, Oura_token, Oura_sleep_descriptions

# from whatSticks01.whatSticksApi04.models import sess, Users,Locations, Weather, Oura_token, Oura_sleep_descriptions
# from whatSticks01.whatSticksApi04 import models
...
def scheduler_funct():
    ...
    job_call_oura_sleep = scheduler.add_job(call_oura_sleep, 'cron', day = '*', hour = '8')
    scheduler.start()
